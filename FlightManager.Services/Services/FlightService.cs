...
namespace FlightManager.Services.Services
{
    public class FlightService : IFlightService
    {
        ...
        private IQueryable<Flight> FlightsWithDetails()
        {
        ...
        {
            return await FlightsWithDetails().ToListAsync();
        }

        public async Task<Flight?> GetFlightByNumberAsync(string flightNumber)
        {
            return await FlightsWithDetails()
        ...
        {
            var query = FlightsWithDetails().AsQueryable();
